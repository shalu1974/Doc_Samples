...
/**
 * Tracks and enables a withdrawal transaction at an ATM by: </br>
 * - Checking the amount available for withdrawal </br>
 * - Checking if the cash was dispensed </br>
 * - Dispensing the cash </br>
 * - Checking if the ATM has sufficient cash to dispense </br>
 * @see Transaction
 */
public class Withdrawal extends Transaction
{
   ...
   /**
    * Constructor. Initializes the withdrawal object by providing the account, ATM, and bank information.
    * @param userAccountNumber Account number
    * @param atmScreen Amount specified on the screen
    * @param atmBankDatabase Bank database object
    * @param atmKeypad ATM key pad object
    * @param atmCashDispenser Cash dispenser object
    */
   ...
   /**
    * Performs the withdrawal transaction after checking if sufficient funds exist in the account and in the ATM cash dispenser.
    * @param amount Amount to be withdrawn from the ATM
    * 
    */
