...
/**
 * 
 * Deposits amount in cash or cheque, into the account.
 *
 */
...
//   private DepositSlot depositSlot; // reference to deposit slot
   ...
   // Deposit constructor
   /**
    * Constructor. Initializes the parent {@link Transaction} class to retrieve the account, screen, and bank information.
    ...
    * @param atmKeypad Instance of the {@link Keypad} class
    */
   ...
   @Override
   /**
    * Prompts the user to enter the deposit amount on  the screen.
    */
   public void execute()
   {
   ...
   /**
    * Receives a deposit into the account through a cheque or cash. This method updates the account balance if the deposit is successful.
