...
/**
 * Represents the following automatic teller machine (ATM) functionalities:</br>
 * - Initiating the ATM screen for login </br>
 * - Validating the login </br>
 * - Validating the pin number</br>
 * - Displaying the account related menu options and information. </br>
 * 
 * @see Screen
 * @see Keypad
 *   
...
//   private DepositSlot depositSlot; // ATM's deposit slot
   ...
   /**
    * Initiates the ATM screen and instance for usage.
    */
   public ATM() 
   {
   ...
   /**
    * Starts the login procedure by validating the card information.
    */
   void startlogin() 
   {
   ...
   /**
    * Authenticates the user by validating the pin number and create the menu.
    ...
    */
      ...
      if (userAuthenticated)
      {
	   ...
	   /**
	    * Creates the user menu to be displayed after a successful login.
	    */
   ...
   /**
    * Creates the admin screen, if the user is an administrator/
    * 
    */
   ...
   /**
    * Checks what buttons were pressed on the key pad.
    * 
    */
   ...
   {
	   /**
	    * Updates the text field based on user input.
	    */
   ...
   /**
    * Enables the user to clear the screen input.
    *     *
    */
   ...
   /**
    * Determines the iterator pattern to move forward on the screen.
    * 
    */
 ...
 //Action listener used for the literator pattern
   /**
    * Determines the iterator pattern to move back on the screen.
    *     *
    */
 ...
 //Action listener used for the literator pattern
   /**
    * Displays the user specific information on the screen during the forward iterator pattern.
    * @param Iterator Iterator patter
    */
 ...
 //Action listener used for the literator pattern
   /**
    * Displays the user specific information on the screen during the back iterator pattern.
    * @param Iterator Iterator pattern
    */
...
//Code used for the Singleton pattern.
   /**
    * Gets an instance of the ATM class.
    * @return ATM instance
    */
